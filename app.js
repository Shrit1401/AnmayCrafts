...
/*! For license information please see vendors.0593b62df1d86f0123be.js.LICENSE.txt */
			...
			var A = [{
				...
				className: function (t) {
					...
					function i(t) {
						...
						return function (t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
						}(this, i), e = r.call(this, t), h.a.dispatch(b.a.BG_SET_COLOR, "#ffe500"), document.documentElement.style.setProperty("--bg-color", "#ffe500"), document.documentElement.style.setProperty("--theme-color", "var(--light)"), e
					}
					return e = i, (n = [{
						key: "destroy",
						value: function () {
